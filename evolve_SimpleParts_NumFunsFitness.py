...
sl.gp_map_pop(pop)
print('line 33 done')
sl.evaluate_pop(pop, evaluate_fun=sl.num_logics_fitness)
print('line 36 done')
...
while gen_count < max_gens:
	...
	### Evalution
	sl.evaluate_pop(invalid_inds, evaluate_fun=sl.num_logics_fitness)
...
output_df.to_csv(PATH + "GA_SimpleParts_NumFunsFitness_gens100_pop50.csv", index=False)
