...
sl.gp_map_pop(pop)
print('line 33 done')
sl.evaluate_pop(pop, evaluate_fun=sl.hybrid_fitness)
print('line 36 done')
...
while gen_count < max_gens:
	...
	### Evalution
	sl.evaluate_pop(invalid_inds, evaluate_fun=sl.hybrid_fitness)
...
output_df.to_csv(PATH + "GA_DoubleParts_HybridFitness_gens100_pop50.csv", index=False)
